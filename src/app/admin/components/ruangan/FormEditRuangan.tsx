...
import { EditRuangan } from "@/lib/_actions/ruangan";
...
const FormEditRuangan = ({ data }: { data: Ruangan }) => {
	const [state, formAction] = useFormState(
		EditRuangan.bind(null, data.id),
		null
	);
	...
	return (
		<>
			...
			<div className="justify-center card-body lg:w-3/5">
				<h3 className="text-lg font-bold">Edit Ruangan</h3>
...
export default FormEditRuangan;
